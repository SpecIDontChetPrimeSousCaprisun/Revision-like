...
void MainMenu::init() {
  ...
  glm::vec2 buttonSize(0.3f, 0.1f);
  glm::vec2 backgroundButtonSize = buttonSize + glm::vec2(0.01f, 0.01f);
  ...
  Button* reviseButton = new Button(glm::vec2(0.5f, 0.45f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.3f), 2, "Reviser", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* reviseButtonBackground = new UIElement(glm::vec2(0.5f, 0.445f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* continueButton = new Button(glm::vec2(0.5f, 0.575f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.3f), 2, "Continuer", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* continueButtonBackground = new UIElement(glm::vec2(0.5f, 0.57f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* creditsButton = new Button(glm::vec2(0.5f, 0.7f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.3f), 2, "Credits", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* creditsButtonBackground = new UIElement(glm::vec2(0.5f, 0.695f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* quitButton = new Button(glm::vec2(0.5f, 0.825f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.3f), 2, "Quitter", "fonts/Kenney Future Narrow.ttf", glm::vec3(1.0f, 0.0f, 0.0f));
  UIElement* quitButtonBackground = new UIElement(glm::vec2(0.5f, 0.82f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  ...
  Button* frenchButton = new Button(glm::vec2(0.5f, 0.35f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.3f), 1, "Francais", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* frenchButtonBackground = new UIElement(glm::vec2(0.5f, 0.345f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* mathButton = new Button(glm::vec2(0.5f, 0.475f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.15f), 1, "Maths", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* mathButtonBackground = new UIElement(glm::vec2(0.5f, 0.47f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* englishButton = new Button(glm::vec2(0.5f, 0.6f), buttonSize, 0.0f, glm::vec3(0.3f, 0.3f, 0.0f), 1, "Anglais", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* englishButtonBackground = new UIElement(glm::vec2(0.5f, 0.595f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* geographyButton = new Button(glm::vec2(0.5f, 0.725f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.0f), 1, "Histoire / Geo / EMC", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* geographyButtonBackground = new UIElement(glm::vec2(0.5f, 0.72f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
  Button* backButton = new Button(glm::vec2(0.5f, 0.85f), buttonSize, 0.0f, glm::vec3(0.3f, 0.0f, 0.0f), 1, "Retour", "fonts/Kenney Future Narrow.ttf", glm::vec3(0.0f, 0.0f, 0.0f));
  UIElement* backButtonBackground = new UIElement(glm::vec2(0.5f, 0.845f), backgroundButtonSize, 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), 1);
